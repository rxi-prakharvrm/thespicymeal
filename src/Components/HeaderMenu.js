...
const HeaderMenu = () => {
    ...
    return (
        <ul className="w-fit flex flex-row justify-between items-center">
            <li className="text-[1.4rem] sm:text-[1.6rem] text-gray-500 px-4 font-semibold flex flex-row-reverse justify-center items-center border-solid border-2 rounded-full" dir="rtl">
            ...
            <li className="pl-6 sm:pl-12 text-[1.4rem] sm:text-[1.6rem] text-gray-700 hover:text-amber-600 font-semibold transition-all ease-in-out delay-50"><Link to="/cart">Cart</Link></li>
        </ul>
    );
};
