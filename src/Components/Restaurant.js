    ...
    return listOfRes.length === 0 ?
        ...
        : (
            <div className="text-center bg-[#f1f1f1] p-24">
                ...
                <input className="w-[40rem] py-4 px-[1.6rem] text-[1.8rem] text-gray-600 outline-none bg-white border-2 border-solid border-gray-200 transition-all hover:shadow-xl hover:shadow-gray-200 rounded-xl" type="text" placeholder="Search you favourite restaurant..." value={searchText} onChange={(e) => { 
